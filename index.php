<?php
require_once'http://sqlite-project-git-sqlite-project.apps.us-west-1.starter.openshift-online.com/classes/queryDb.php';
...
<body>
	...
	<div class="index-banner">
		<img src="images/main-banner.jpg" alt="" style="width: 100%; height: 422px;">
	</div>
	<!-- Welcome Text -->
	<div class="product-search-steps">
		<h4>Our Newly Added Products</h4>
